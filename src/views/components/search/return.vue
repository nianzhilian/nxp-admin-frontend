<template>
	<div v-show="page.count > 0">
		<div class="air-title h3">退货单搜索</div>
		<div v-if="queryStr == ''">
	...
	export default {
		...
		methods: {
			initData() {
				...
				_self.data = [];
				_self.count = 0;
				fetchGet('/nxp-admin/retord/searchReturnOrder?key=' + _self.val + '&page=' + _self.page.page + '&pageSize=' + _self.page.size + '&type=1').then((res) => {
					if(res.flag !== 0) {
